...
export async function evaluatePayrollGlReadiness(
  ...
  // Phase 3 follow-up (2026-09-16) — the deprecated
  // PayrollGlDepartmentOverride table has been dropped. Departmental
  // attribution now travels on JournalEntryLine.departmentId
  // (Spectre's canonical dimension). No per-department account
  // overrides exist to validate — the global profile checks below
