// Payroll Admin Slice 3F (2026-09-13) — Post Payroll server action
// for the Payroll Overview surface. Delegates to canonical
// `postPayrollBatch` domain service.
...
export async function postPayrollAction(formData: FormData): Promise<void> {
  ...
  await postPayrollBatch(principal, batchId);
