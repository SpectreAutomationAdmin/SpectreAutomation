...
function baseParams(): CanadianPayrollStatutoryParamsV1 {
  return {
    ...
    cpp: {
      ...
      firstAdditionalMaxEE: "650.00",
      firstAdditionalMaxER: "650.00",
      combinedRateEE: "0.0595",
      combinedRateER: "0.0595",
      combinedMaxEE: "3867.50",
      combinedMaxER: "3867.50",
      cpp2RateEE: "0.04",
      cpp2RateER: "0.04",
      cpp2MaxEE: "188.00",
      cpp2MaxER: "188.00",
    ...
    ei: {
      mie: "65700", rateEE: "0.0164", rateER: "0.02296",
      maxAnnualPremiumEE: "1077.48", maxAnnualPremiumER: "1508.47",
