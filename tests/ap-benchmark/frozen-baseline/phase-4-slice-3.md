# AP Intelligence Benchmark — ap-bench-2026-08-06T22-50-54-777Z-p0on-p2on

| | |
|---|---|
| Corpus | `v2-2026-08-06` |
| Phase 0 containment | `ENABLED` |
| Started | 2026-08-06T22:50:54.778Z |
| Finished | 2026-08-06T22:50:58.220Z |
| Cases | 21 (pass 12 · partial 0 · fail 9 · n/a 0) |
| Unsafe recommendations | **0** |
| Correct abstention on unreadable | 5 |
| False abstention | 0 |
| Latency p50 / p95 (ms) | 59 / 117 |
...
| `currency` | 18 | 1 | 0 | 0 | 0.947 |
| `gl-forbidden` | 14 | 0 | 0 | 0 | 1.000 |
| `gl-top1` | 9 | 5 | 0 | 0 | 0.643 |
| `gl-top3` | 4 | 7 | 0 | 0 | 0.364 |
| `invoiceNumber` | 19 | 0 | 0 | 0 | 1.000 |
| `subtotal` | 18 | 0 | 0 | 0 | 1.000 |
| `supplier` | 19 | 0 | 0 | 0 | 1.000 |
| `taxTotal` | 18 | 0 | 0 | 0 | 1.000 |
| `total` | 18 | 1 | 0 | 0 | 0.947 |
| `vendorMatch` | 10 | 2 | 0 | 0 | 0.833 |
| `workflow-false-auto` | 21 | 0 | 0 | 0 | 1.000 |
| `workflow-false-ready` | 21 | 0 | 0 | 0 | 1.000 |
| `workflowState` | 21 | 0 | 0 | 0 | 1.000 |

## Case results

### DMM Energy — dyed low-sulphur diesel · Québec French headers
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 109 ms
...
- Split: `dev` · Category: `CAPITAL_INVOICE` · Overall: **FAIL** · Latency: 117 ms
...
- Split: `dev` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 76 ms
- Supplier: `Northside Course Maintenance Inc`
...
- Split: `dev` · Category: `ATTACHMENT_AUTHORITY` · Overall: **FAIL** · Latency: 70 ms
...
- Split: `dev` · Category: `INFORMATIONAL_EMAIL` · Overall: **PASS** · Latency: 54 ms
...
- Split: `dev` · Category: `UNREADABLE` · Overall: **PASS** · Latency: 38 ms
- Supplier: `(none)`
- Invoice #: `(none)`
- Total: `(none) `
- GL Top-1: `(abstained) ` (confidence: `0`)
...
- Split: `dev` · Category: `STATEMENT` · Overall: **FAIL** · Latency: 37 ms
- Supplier: `Oakcreek Golf & Turf LP`
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **PASS** · Latency: 44 ms
...
- Split: `dev` · Category: `PATHOLOGICAL` · Overall: **FAIL** · Latency: 34 ms
...
- Split: `dev` · Category: `STRUCTURAL_GAP_MEASUREMENT` · Overall: **PASS** · Latency: 64 ms
- Supplier: `Grande Prairie Petroleum Inc`
...
- Split: `dev` · Category: `ADVERSARIAL_CAPITAL` · Overall: **FAIL** · Latency: 153 ms
...
- Split: `dev` · Category: `SUPPLIER_DISAMBIGUATION` · Overall: **PASS** · Latency: 69 ms
...
- Split: `dev` · Category: `SUPPLIER_DISAMBIGUATION` · Overall: **PASS** · Latency: 59 ms
...
- Split: `dev` · Category: `CURRENCY_HIERARCHY` · Overall: **PASS** · Latency: 65 ms
...
- Split: `dev` · Category: `TAX_DEDUPLICATION` · Overall: **PASS** · Latency: 67 ms
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 81 ms
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 57 ms
- Supplier: `Greenwood Turf Nutrition Ltd.`
- Invoice #: `CM-2026-0071`
- Total: `-1260.00 CAD`
- GL Top-1: `(abstained) ` (confidence: `0`)
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 58 ms
...
- Split: `validation` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 50 ms
