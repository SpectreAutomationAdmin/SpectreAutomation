# AP Intelligence Benchmark — ap-bench-2026-08-06T13-20-27-932Z-p0on-p2on

| | |
|---|---|
| Corpus | `v2-2026-08-06` |
| Phase 0 containment | `ENABLED` |
| Started | 2026-08-06T13:20:27.933Z |
| Finished | 2026-08-06T13:20:35.075Z |
| Cases | 24 (pass 14 · partial 0 · fail 10 · n/a 0) |
| Unsafe recommendations | **0** |
| Correct abstention on unreadable | 5 |
| False abstention | 0 |
| Latency p50 / p95 (ms) | 125 / 228 |
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 520 ms
...
- Split: `dev` · Category: `CAPITAL_INVOICE` · Overall: **FAIL** · Latency: 228 ms
...
- Split: `dev` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 153 ms
- Supplier: `Northside Course Maintenance Inc`
...
- Split: `dev` · Category: `ATTACHMENT_AUTHORITY` · Overall: **FAIL** · Latency: 174 ms
...
- Split: `dev` · Category: `INFORMATIONAL_EMAIL` · Overall: **PASS** · Latency: 121 ms
...
- Split: `dev` · Category: `UNREADABLE` · Overall: **PASS** · Latency: 79 ms
- Supplier: `(none)`
- Invoice #: `(none)`
- Total: `(none) `
- GL Top-1: `(abstained) ` (confidence: `0`)
...
- Split: `dev` · Category: `STATEMENT` · Overall: **FAIL** · Latency: 79 ms
- Supplier: `Oakcreek Golf & Turf LP`
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **PASS** · Latency: 149 ms
...
- Split: `dev` · Category: `PATHOLOGICAL` · Overall: **FAIL** · Latency: 125 ms
...
- Split: `dev` · Category: `STRUCTURAL_GAP_MEASUREMENT` · Overall: **PASS** · Latency: 164 ms
- Supplier: `Grande Prairie Petroleum Inc`
...
- Split: `dev` · Category: `ADVERSARIAL_CAPITAL` · Overall: **FAIL** · Latency: 160 ms
...
- Split: `dev` · Category: `SUPPLIER_DISAMBIGUATION` · Overall: **PASS** · Latency: 180 ms
...
- Split: `dev` · Category: `SUPPLIER_DISAMBIGUATION` · Overall: **PASS** · Latency: 99 ms
...
- Split: `dev` · Category: `CURRENCY_HIERARCHY` · Overall: **PASS** · Latency: 154 ms
...
- Split: `dev` · Category: `TAX_DEDUPLICATION` · Overall: **PASS** · Latency: 140 ms
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 196 ms
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 68 ms
...
- Split: `dev` · Category: `PAYABLE_REFERENCE_TAXONOMY` · Overall: **PASS** · Latency: 117 ms
...
- Split: `validation` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 95 ms
