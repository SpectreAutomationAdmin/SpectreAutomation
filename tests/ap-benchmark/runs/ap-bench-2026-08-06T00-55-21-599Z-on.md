# AP Intelligence Benchmark — ap-bench-2026-08-06T00-55-21-599Z-on

| | |
|---|---|
| Corpus | `v1-2026-08-06` |
| Phase 0 containment | `ENABLED` |
| Started | 2026-08-06T00:55:21.601Z |
| Finished | 2026-08-06T00:55:25.047Z |
| Cases | 12 (pass 0 · partial 0 · fail 12 · n/a 0) |
| Unsafe recommendations | **0** |
| Correct abstention on unreadable | 4 |
| False abstention | 0 |
| Latency p50 / p95 (ms) | 63 / 284 |

## Per-dimension

| Dimension | Pass | Fail | Partial | N/A | Avg score |
|---|---:|---:|---:|---:|---:|
| `abstention` | 4 | 0 | 0 | 0 | 1.000 |
| `currency` | 1 | 9 | 0 | 0 | 0.100 |
| `gl-forbidden` | 12 | 0 | 0 | 0 | 1.000 |
| `gl-top1` | 8 | 4 | 0 | 0 | 0.667 |
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 284 ms
...
- Split: `dev` · Category: `CAPITAL_INVOICE` · Overall: **FAIL** · Latency: 107 ms
...
- Split: `dev` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 116 ms
- Supplier: `Northside Course Maintenance Inc`
...
- Split: `dev` · Category: `ATTACHMENT_AUTHORITY` · Overall: **FAIL** · Latency: 74 ms
...
- Split: `dev` · Category: `INFORMATIONAL_EMAIL` · Overall: **FAIL** · Latency: 57 ms
...
- Split: `dev` · Category: `UNREADABLE` · Overall: **FAIL** · Latency: 44 ms
- Supplier: `(none)`
- Invoice #: `(none)`
- Total: `(none) `
- GL Top-1: `(abstained) ` (confidence: `0`)
...
- Split: `dev` · Category: `STATEMENT` · Overall: **FAIL** · Latency: 58 ms
- Supplier: `Oakcreek Golf & Turf LP`
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 63 ms
...
- Split: `dev` · Category: `PATHOLOGICAL` · Overall: **FAIL** · Latency: 112 ms
...
- Split: `validation` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 56 ms
