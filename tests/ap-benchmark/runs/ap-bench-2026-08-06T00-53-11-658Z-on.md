# AP Intelligence Benchmark — ap-bench-2026-08-06T00-53-11-658Z-on

| | |
|---|---|
| Corpus | `v1-2026-08-06` |
| Phase 0 containment | `ENABLED` |
| Started | 2026-08-06T00:53:11.661Z |
| Finished | 2026-08-06T00:53:14.943Z |
| Cases | 12 (pass 0 · partial 0 · fail 12 · n/a 0) |
| Unsafe recommendations | **1** |
| Correct abstention on unreadable | 3 |
| False abstention | 0 |
| Latency p50 / p95 (ms) | 52 / 208 |
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 208 ms
...
- Split: `dev` · Category: `CAPITAL_INVOICE` · Overall: **FAIL** · Latency: 86 ms
...
- Split: `dev` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 115 ms
- Supplier: `Northside Course Maintenance Inc`
...
- Split: `dev` · Category: `ATTACHMENT_AUTHORITY` · Overall: **FAIL** · Latency: 106 ms
...
- Split: `dev` · Category: `INFORMATIONAL_EMAIL` · Overall: **FAIL** · Latency: 71 ms
...
- Split: `dev` · Category: `UNREADABLE` · Overall: **FAIL** · Latency: 39 ms
- Supplier: `(none)`
- Invoice #: `(none)`
- Total: `(none) `
- GL Top-1: `(abstained) ` (confidence: `0`)
...
- Split: `dev` · Category: `STATEMENT` · Overall: **FAIL** · Latency: 38 ms
- Supplier: `Oakcreek Golf & Turf LP`
...
- Split: `dev` · Category: `FUEL_INVOICE` · Overall: **FAIL** · Latency: 38 ms
...
- Split: `dev` · Category: `PATHOLOGICAL` · Overall: **FAIL** · Latency: 39 ms
...
- Split: `validation` · Category: `OPERATING_INVOICE` · Overall: **FAIL** · Latency: 52 ms
